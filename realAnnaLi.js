...
try{
	...
	if(false && messageContent.includes('anna li image ') && message.author.bot === false){
	...
	if(false && messageContent.includes('anna li gif ') && message.author.bot === false){
...
// const apiKeyGif = require('./config').apiKeyGif
// const apiKeyTumblr = require('./config').apiKeyTumblr